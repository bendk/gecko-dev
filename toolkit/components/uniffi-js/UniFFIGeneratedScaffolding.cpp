...
Maybe<already_AddRefed<Promise>> UniFFICallAsync(const GlobalObject& aGlobal, uint64_t aId, const Sequence<ScaffoldingType>& aArgs, ErrorResult& aError) {
  switch (aId) {
    ...
    case 1: { // remote_settings:uniffi_remote_settings_fn_method_remotesettings_get_records
    ...
    case 2: { // remote_settings:uniffi_remote_settings_fn_method_remotesettings_get_records_since
    ...
    case 3: { // remote_settings:uniffi_remote_settings_fn_method_remotesettings_download_attachment_to_path
    ...
    case 4: { // tabs:uniffi_tabs_fn_constructor_tabsstore_new
    ...
    case 5: { // tabs:uniffi_tabs_fn_method_tabsstore_get_all
    ...
    case 6: { // tabs:uniffi_tabs_fn_method_tabsstore_set_local_tabs
    ...
    case 7: { // tabs:uniffi_tabs_fn_method_tabsstore_register_with_sync_manager
    ...
    case 8: { // tabs:uniffi_tabs_fn_method_tabsstore_bridged_engine
    ...
    case 9: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_last_sync
    ...
    case 10: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_set_last_sync
    ...
    case 11: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_sync_id
    ...
    case 12: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_reset_sync_id
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<RustBuffer>, ScaffoldingObjectConverter<&kTabsTabsBridgedEnginePointerType>>;
    ...
    case 13: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_ensure_current_sync_id
    ...
    case 14: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_prepare_for_sync
    ...
    case 15: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_sync_started
    ...
    case 16: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_store_incoming
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<void>, ScaffoldingObjectConverter<&kTabsTabsBridgedEnginePointerType>, ScaffoldingConverter<RustBuffer>>;
    ...
    case 18: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_set_uploaded
    ...
    case 20: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_reset
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<void>, ScaffoldingObjectConverter<&kTabsTabsBridgedEnginePointerType>>;
    ...
    case 21: { // tabs:uniffi_tabs_fn_method_tabsbridgedengine_wipe
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<void>, ScaffoldingObjectConverter<&kTabsTabsBridgedEnginePointerType>>;
    ...
    case 22: { // suggest:uniffi_suggest_fn_constructor_suggeststore_new
    ...
    case 23: { // suggest:uniffi_suggest_fn_method_suggeststore_query
    ...
    case 24: { // suggest:uniffi_suggest_fn_method_suggeststore_interrupt
    ...
    case 25: { // suggest:uniffi_suggest_fn_method_suggeststore_ingest
    ...
    case 26: { // suggest:uniffi_suggest_fn_method_suggeststore_clear
      using CallHandler = ScaffoldingCallHandler<ScaffoldingConverter<void>, ScaffoldingObjectConverter<&kSuggestSuggestStorePointerType>>;
    ...
    case 27: { // suggest:uniffi_suggest_fn_func_raw_suggestion_url_matches
