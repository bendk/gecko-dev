...
class FfiValueInt {
 ...
 public:
  FfiValueInt() = default;
  FfiValueInt(T aValue) : mValue(aValue) {}

  static FfiValueInt Lower(const dom::OwningUniFFIScaffoldingValue& aValue,
                           ErrorResult& aError) {
    if (!aValue.IsDouble()) {
...
class FfiValueFloat {
 ...
 public:
  ...
  FfiValueFloat(T aValue) : mValue(aValue) {}

  static FfiValueFloat Lower(const dom::OwningUniFFIScaffoldingValue& aValue,
                             ErrorResult& aError) {
    if (!aValue.IsDouble()) {
      aError.ThrowTypeError("Bad argument type"_ns);
      return T();
    }
    return T(aValue.GetAsDouble());
  }
...
class FfiValueRustBuffer {
 ...
 public:
  ...
  FfiValueRustBuffer(RustBuffer aValue) : mValue(OwnedRustBuffer(aValue)) {}
  FfiValueRustBuffer(OwnedRustBuffer aValue) : mValue(std::move(aValue)) {}

  static FfiValueRustBuffer Lower(
      const dom::OwningUniFFIScaffoldingValue& aValue, ErrorResult& aError) {
    if (!aValue.IsArrayBuffer()) {
      aError.ThrowTypeError("Expected ArrayBuffer argument"_ns);
      return OwnedRustBuffer{};
    }
    return FfiValueRustBuffer(
        OwnedRustBuffer::FromArrayBuffer(aValue.GetAsArrayBuffer()));
  }
...
class FfiValueObjectHandle {
 ...
 public:
  ...
  FfiValueObjectHandle(void* aValue) : mValue(aValue) {}
  ...
  static FfiValueObjectHandle Lower(
    ...
    return FfiValueObjectHandle(value.ClonePtr());
  }
