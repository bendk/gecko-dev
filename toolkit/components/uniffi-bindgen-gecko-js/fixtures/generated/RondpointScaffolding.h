...
class RondpointScaffolding {
  ...
  ErrorResult& aUniFFIErrorResult);
  static already_AddRefed<Promise> Rondpoint9336CopieEnumeration(const GlobalObject& aUniFFIGlobal,const ArrayBuffer& e,
  ErrorResult& aUniFFIErrorResult);
  static already_AddRefed<Promise> Rondpoint9336CopieEnumerations(const GlobalObject& aUniFFIGlobal,const ArrayBuffer& e,
  ErrorResult& aUniFFIErrorResult);
  static already_AddRefed<Promise> Rondpoint9336CopieCarte(const GlobalObject& aUniFFIGlobal,const ArrayBuffer& c,
  ErrorResult& aUniFFIErrorResult);
