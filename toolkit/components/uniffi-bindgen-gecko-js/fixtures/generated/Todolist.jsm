...
class TodoList {
    ...
    const functionCall = () => {
        ...
        return TodolistScaffolding.todolistB183TodoListNew(
        )
    }
    try {
    ...
    const functionCall = () => {
        ...
        return TodolistScaffolding.todolistB183TodoListAddItem(FfiConverterTypeTodoList.lower(this),
    ...
    const functionCall = () => {
        ...
        return TodolistScaffolding.todolistB183TodoListAddEntry(FfiConverterTypeTodoList.lower(this),
    ...
    const functionCall = () => {
        ...
        return TodolistScaffolding.todolistB183TodoListGetEntries(FfiConverterTypeTodoList.lower(this),
    ...
    const functionCall = () => {
        ...
        return TodolistScaffolding.todolistB183TodoListGetItems(FfiConverterTypeTodoList.lower(this),
    ...
    const functionCall = () => {
        ...
        return TodolistScaffolding.todolistB183TodoListAddEntries(FfiConverterTypeTodoList.lower(this),
    ...
    const functionCall = () => {
        ...
        return TodolistScaffolding.todolistB183TodoListAddItems(FfiConverterTypeTodoList.lower(this),
    ...
    const functionCall = () => {
        ...
        return TodolistScaffolding.todolistB183TodoListGetLastEntry(FfiConverterTypeTodoList.lower(this),
    ...
    const functionCall = () => {
        ...
        return TodolistScaffolding.todolistB183TodoListGetLast(FfiConverterTypeTodoList.lower(this),
    ...
    const functionCall = () => {
        ...
        return TodolistScaffolding.todolistB183TodoListGetFirst(FfiConverterTypeTodoList.lower(this),
    ...
    const functionCall = () => {
        ...
        return TodolistScaffolding.todolistB183TodoListClearItem(FfiConverterTypeTodoList.lower(this),
            FfiConverterString.lower(todo),
        )
    }
    try {
    ...
    const functionCall = () => {
        ...
        return TodolistScaffolding.todolistB183TodoListMakeDefault(FfiConverterTypeTodoList.lower(this),
    ...
    destroy() {
        ...
        if (this.callCounter === 0) {
            TodolistScaffolding.ffiTodolistB183TodoListObjectFree(this.ptr);
        }
    }
...
function getDefaultList() {
    ...
    const functionCall = () => {
        ...
        return TodolistScaffolding.todolistB183GetDefaultList(
        )
    }
    try {
        return functionCall().then((result) => handleRustResult(result,  liftResult, liftError));
...
function setDefaultList(list) {
    ...
    const functionCall = () => {
        ...
        return TodolistScaffolding.todolistB183SetDefaultList(FfiConverterTypeTodoList.lower(list),
        )
    }
    try {
        return functionCall().then((result) => handleRustResult(result,  liftResult, liftError));
...
function createEntryWith(todo) {
    ...
    const functionCall = () => {
        ...
        return TodolistScaffolding.todolistB183CreateEntryWith(FfiConverterString.lower(todo),
        )
    }
    try {
        return functionCall().then((result) => handleRustResult(result,  liftResult, liftError));
