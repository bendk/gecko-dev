...
export class TodoList {
    ...
    static init() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                33, // todolist:uniffi_todolist_fn_constructor_todolist_new
            )
        }
        try {
    ...
    addItem(todo) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                34, // todolist:uniffi_todolist_fn_method_todolist_add_item
    ...
    addEntry(entry) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                35, // todolist:uniffi_todolist_fn_method_todolist_add_entry
                FfiConverterTypeTodoList.lower(this),
    ...
    getEntries() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                36, // todolist:uniffi_todolist_fn_method_todolist_get_entries
                FfiConverterTypeTodoList.lower(this),
            )
        }
        try {
    ...
    getItems() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                37, // todolist:uniffi_todolist_fn_method_todolist_get_items
                FfiConverterTypeTodoList.lower(this),
            )
        }
        try {
    ...
    addEntries(entries) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                38, // todolist:uniffi_todolist_fn_method_todolist_add_entries
                FfiConverterTypeTodoList.lower(this),
    ...
    addItems(items) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                39, // todolist:uniffi_todolist_fn_method_todolist_add_items
                FfiConverterTypeTodoList.lower(this),
    ...
    getLastEntry() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                40, // todolist:uniffi_todolist_fn_method_todolist_get_last_entry
                FfiConverterTypeTodoList.lower(this),
            )
        }
        try {
    ...
    getLast() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                41, // todolist:uniffi_todolist_fn_method_todolist_get_last
                FfiConverterTypeTodoList.lower(this),
            )
        }
        try {
    ...
    getFirst() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                42, // todolist:uniffi_todolist_fn_method_todolist_get_first
                FfiConverterTypeTodoList.lower(this),
            )
        }
        try {
    ...
    clearItem(todo) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                43, // todolist:uniffi_todolist_fn_method_todolist_clear_item
                FfiConverterTypeTodoList.lower(this),
                FfiConverterString.lower(todo),
            )
        }
    ...
    makeDefault() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                44, // todolist:uniffi_todolist_fn_method_todolist_make_default
                FfiConverterTypeTodoList.lower(this),
            )
        }
        try {
...
export function getDefaultList() {
        ...
        const functionCall = () => {
            return UniFFIScaffolding.callAsync(
                45, // todolist:uniffi_todolist_fn_func_get_default_list
            )
        }
        try {
            return functionCall().then((result) => handleRustResult(result, liftResult, liftError));
...
export function setDefaultList(list) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                46, // todolist:uniffi_todolist_fn_func_set_default_list
...
export function createEntryWith(todo) {
        ...
        const functionCall = () => {
            ...
            return UniFFIScaffolding.callAsync(
                47, // todolist:uniffi_todolist_fn_func_create_entry_with
                FfiConverterString.lower(todo),
            )
        }
        try {
